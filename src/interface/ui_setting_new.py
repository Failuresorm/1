...
"        }        ")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -440, 727, 3171))
        ...
        self.windowsize = QCheckBox(self.frame_18)
        self.windowsize.setObjectName(u"windowsize")

        self.verticalLayout_22.addWidget(self.windowsize)
    ...
    def retranslateUi(self, SettingNew):
        ...
        self.label_41.setText(QCoreApplication.translate("SettingNew", u"<html><head/><body><p><span style=\" font-size:12pt;\">\u4fdd\u5b58\u7a97\u53e3\u4f4d\u7f6e\u548c\u5927\u5c0f</span></p></body></html>", None))
